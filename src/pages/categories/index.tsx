...
const CategPage=():React.ReactElement=>{
    ...
    <main>
        ...
        <div className="main-discovery">Whatever you’re craving - we’ll deliver it to your door. Feel like having pizza, sushi or your favourite dish from Tatooine? Explore your possibilities below. </div>
        <CategSection/>
