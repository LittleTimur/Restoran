...
const Carusel_Categories=():React.ReactElement =>{
    ...
    return(<>
            <div className="categories">
                ...
                <div className="categories-container" ref={containerRef} style={{ transform: `translateX(${offset}px)` }}>
                ...
                <button className="btn-right btn-cat" ref={btnRightRef} onClick={() => setOffset(prevOffset => moveContainer(containerRef.current, prevOffset, -300))}>
                    <img className="arrow-right" src="img/arrow-right.svg" alt=""/>
                </button>
                }
                {
                offset !== 0 &&
                <button className="btn-left btn-cat" ref={btnLeftRef} onClick={() => setOffset(prevOffset => moveContainer(containerRef.current, prevOffset, 300))}>
