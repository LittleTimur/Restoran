...
const Carusel_Arrivals=():React.ReactElement =>{
    ...
    return(<>
            <div className="favourite-picks">
                ...
                <div className="favourite-picks-container" ref={containerRef} style={{ transform: `translateX(${offset}px)` }}>
                ...
                {offset !== 0 &&
                <button className="btn-left" ref={btnLeftRef} onClick={() => setOffset(prevOffset => moveContainer(containerRef.current, prevOffset, 300))}>
                    <img className="arrow-left" src="img/arrow-left.svg" alt="" />
                </button>
                }
                {offset !== (containerWidth - document.body.scrollWidth + 115) * -1 &&
                <button className="btn-right" ref={btnRightRef} onClick={() => setOffset(prevOffset => moveContainer(containerRef.current, prevOffset, -300))}>
